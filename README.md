...
[![Architecture](https://img.shields.io/badge/Arch-x64-blue?style=for-the-badge)]()
...
> Делал для себя, потому что родной софт от ID-COOLING бесил вылетами, жрал память и намертво зависал во время каток.
...
Это мой первый публичный проект. Писал под Windows, но теоретически основные используемые библиотеки поддерживаются и на Linux. 
